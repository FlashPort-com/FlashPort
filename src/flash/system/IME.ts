...
export class IME extends EventDispatcher
{
	 ...
	 * @playerversion	AIR 2
	 */
	public static compositionAbandoned () : void{
	 ...
	 * @playerversion	AIR 2
	 */
	public static compositionSelectionChanged (start:number, end:number) : void{
	 ...
	 */
	public static doConversion () : void{
	 ...
	 */
	public static setCompositionString (composition:string) : void{
