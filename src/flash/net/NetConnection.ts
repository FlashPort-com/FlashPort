 ...
 * console.log("Stream not found: " + videoURL);
 * break;
 * }
 * }
 * 
...
export class NetConnection extends EventDispatcher
{
	...
	{
		console.log("WARNING NetConnection.client property not implemented.");
		return null;
	}
	...
	{
		console.log("WARNING NetConnection.connected property not implemented.");
		return true;
	}
	 ...
	 *   was not connected.
	 */
	public get connectedProxyType () : string
	{
		console.log("WARNING NetConnection.connectedProxyType property not implemented.");
		return "";
	}
	 ...
	 * @playerversion	Lite 4
	 */
	public static get defaultObjectEncoding () : number
	{
		console.log("WARNING NetConnection.defaultObjectEncoding property not implemented.");
		return null;
	}
	public static set defaultObjectEncoding (version:number)
	{
		console.log("WARNING NetConnection.defaultObjectEncoding property not implemented.");
	}
	...
	{
		console.log("WARNING NetConnection.farID property not implemented.");
		return "";
	}
	...
	{
		console.log("WARNING NetConnection.farNonce property not implemented.");
		return "";
	}
	 ...
	 * @playerversion	AIR 1.5
	 */
	public get maxPeerConnections () : number
	{
		console.log("WARNING NetConnection.maxPeerConnections property not implemented.");
		return null;
	}
	public set maxPeerConnections (maxPeers:number)
	{
		console.log("WARNING NetConnection.maxPeerConnections property not implemented.");
	}
	 ...
	 * @playerversion	AIR 1.5
	 */
	public get nearID () : string
	{
		console.log("WARNING NetConnection.nearID property not implemented.");
		return "";
	}
	...
	{
		console.log("WARNING NetConnection.nearNonce property not implemented.");
		return "";
	}
	...
	{
		console.log("WARNING NetConnection.objectEncoding property not implemented.");
		return null;
	}
	...
	{
		console.log("WARNING NetConnection.protocol property not implemented.");
		return "";
	}
	...
	{
		console.log("WARNING NetConnection.proxyType property not implemented.");
		return "";
	}
	public set proxyType (ptype:string)
	{
		console.log("WARNING NetConnection.proxyType property not implemented.");
	}
	 ...
	 * @playerversion	AIR 1.5
	 */
	public get unconnectedPeerStreams () : any[]
	{
		console.log("WARNING NetConnection.unconnectedPeerStreams property not implemented.");
		return [];
	}
	...
	{
		console.log("WARNING NetConnection.uri property not implemented.");
		return "";
	}
	 ...
	 *   was not connected.
	 */
	public get usingTLS () : boolean
	{
		console.log("WARNING NetConnection.usingTLS property not implemented.");
		return false;
	}
	...
	public connect = (command:string, ...rest) : void =>
	{
		if (command)
		{
			console.log("WARNING NetConnection.connect method is implemented for playing local files only.");
			this.dispatchEvent(new NetStatusEvent(NetStatusEvent.NET_STATUS, false, false, {code:"NetStream.Play.StreamNotFound"}));
		}
		else
		{
			this.dispatchEvent(new NetStatusEvent(NetStatusEvent.NET_STATUS, false, false, {code:"NetConnection.Connect.Success"}));
		}
	}
