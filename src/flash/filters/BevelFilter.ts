...
export class BevelFilter extends BitmapFilter
{
	 ...
	 *   </listing>
	 */
	constructor (distance:number = 4, angle:number = 45, highlightColor:number = 16777215, highlightAlpha:number = 1, shadowColor:number = 0, shadowAlpha:number = 1, blurX:number = 4, blurY:number = 4, strength:number = 1, quality:number = 1, type:string = "inner", knockout:boolean = false){
		super();
	}
