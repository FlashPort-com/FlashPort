	...
	{
		private _builtInItems:ContextMenuBuiltInItems;
		private _clipboardItems:ContextMenuClipboardItems;
		private _clipboardMenu:boolean = false;
		private _customItems:any[] = [];
		private _link:URLRequest;
		
		private static _isSupported:boolean = true;
		/**
		 ...
		 * @playerversion	Flash 9
		 */
		public get builtInItems () : ContextMenuBuiltInItems { return this._builtInItems; }
		public set builtInItems (value:ContextMenuBuiltInItems) { this._builtInItems = value; }
		 ...
		 */
		public get clipboardItems () : ContextMenuClipboardItems { return this._clipboardItems; }
		public set clipboardItems (value:ContextMenuClipboardItems) { this._clipboardItems = value; }
		 ...
		 * @playerversion	AIR 1.5
		 */
		public get clipboardMenu () : boolean { return this._clipboardMenu; }
		public set clipboardMenu (value:boolean) { this._clipboardMenu = value; }
		 ...
		 * @playerversion	Flash 9
		 */
		public get customItems () : any[] { return this._customItems; }
		public set customItems (value:any[]) { this._customItems = value; }
		 ...
		 * @playerversion	AIR 2
		 */
		public static get isSupported():boolean { return ContextMenu._isSupported; }
		 ...
		 * @playerversion	AIR 1.5
		 */
		public get link ():URLRequest { return this._link }
		public set link (value:URLRequest) { this._link = value; }

		/**
		 * Creates a copy of the menu and all items.
		 * @playerversion	AIR 1.0
		 */
		public clone():NativeMenu
		{
			return null;
		}
