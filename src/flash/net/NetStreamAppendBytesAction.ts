 ...
 * @playerversion	AIR 2
 */
export class NetStreamAppendBytesAction extends Object
{
	/**
	 ...
	 * @playerversion	AIR 2
	 */
	public static END_SEQUENCE : string = "endSequence";
	 ...
	 * @playerversion	AIR 2
	 */
	public static RESET_BEGIN : string = "resetBegin";
	 ...
	 * @playerversion	AIR 2
	 */
	public static RESET_SEEK : string = "resetSeek";
