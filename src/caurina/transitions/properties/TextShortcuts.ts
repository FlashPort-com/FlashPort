...
export class TextShortcuts {
	...
	{
		// Normal properties
		Tweener.registerSpecialProperty("_text", TextShortcuts._text_get, TextShortcuts._text_set, null, TextShortcuts._text_preProcess);
//		Tweener.registerSpecialPropertyModifier("_text", _text_modifier, _text_get);

		// TextFormat-based properties
		Tweener.registerSpecialPropertySplitter("_text_color",		TextShortcuts._generic_color_splitter, ["_text_color_r", "_text_color_g", "_text_color_b"]);
		Tweener.registerSpecialProperty("_text_color_r",			TextShortcuts._textFormat_property_get,	TextShortcuts._textFormat_property_set,	["color", true, "r"]);
		Tweener.registerSpecialProperty("_text_color_g",			TextShortcuts._textFormat_property_get,	TextShortcuts._textFormat_property_set,	["color", true, "g"]);
		Tweener.registerSpecialProperty("_text_color_b",			TextShortcuts._textFormat_property_get,	TextShortcuts._textFormat_property_set,	["color", true, "b"]);
		Tweener.registerSpecialProperty("_text_indent",				TextShortcuts._textFormat_property_get,	TextShortcuts._textFormat_property_set,	["indent"]);
		Tweener.registerSpecialProperty("_text_leading",			TextShortcuts._textFormat_property_get,	TextShortcuts._textFormat_property_set,	["leading"]);
		Tweener.registerSpecialProperty("_text_leftMargin",			TextShortcuts._textFormat_property_get,	TextShortcuts._textFormat_property_set,	["leftMargin"]);
		Tweener.registerSpecialProperty("_text_letterSpacing",		TextShortcuts._textFormat_property_get,	TextShortcuts._textFormat_property_set,	["letterSpacing"]);
		Tweener.registerSpecialProperty("_text_rightMargin",		TextShortcuts._textFormat_property_get,	TextShortcuts._textFormat_property_set,	["rightMargin"]);
		Tweener.registerSpecialProperty("_text_size",				TextShortcuts._textFormat_property_get,	TextShortcuts._textFormat_property_set,	["size"]);
	 ...
	 */
	public static _text_get = (p_obj:any, p_parameters:any[], p_extra:any = null):number =>
	{
	 ...
	 */
	public static _text_set = (p_obj:any, p_value:number, p_parameters:any[], p_extra:any = null): void =>
	{
	...
	public static _text_preProcess = (p_obj:any, p_parameters:any[], p_originalValueComplete:any, p_extra:any): number =>
	{
	 ...
	 */
	public static _generic_color_splitter = (p_value:number, p_parameters:any[]):any[] =>
	{
	 ...
	 */
	public static _textFormat_property_get = (p_obj:any, p_parameters:any[], p_extra:any = null):number =>
	{
	...
	public static _textFormat_property_set = (p_obj:any, p_value:number, p_parameters:any[], p_extra:any = null): void =>
	{
		var fmt:TextFormat = p_obj.getTextFormat();
		var propertyName:string = p_parameters[0];
		var isColor:boolean = p_parameters[1];
